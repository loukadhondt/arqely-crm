...
const dict = {
  ...
  mrr: ['MRR abonnements', 'Subscription MRR'],
  signed_total: ['Signé (valeur initiale HTVA)', 'Signed (initial value excl. VAT)'],
  signed_monthly: ['Récurrent signé', 'Signed recurring'],
  won_deals: ['affaire(s) gagnée(s)', 'won deal(s)'],
  excl_vat: ['HTVA', 'excl. VAT'],
  shown_separately: ['affiché séparément, non additionné au signé', 'shown separately, not added to signed'],
  estimates: ['estimations', 'estimates'],
  memo: ['Mémo de travail', 'Working memo'],
  memo_help: ['Contexte de référence pour l’équipe et pour Claude. Modifiable ; enregistré pour tout le monde.', 'Reference context for the team and for Claude. Editable; saved for everyone.'],
  ...
  deal: ['Affaire', 'Deal'],
  title: ['Titre', 'Title'],
  amount: ['Valeur du contrat HTVA (€)', 'Contract value excl. VAT (€)'],
  monthly_amount: ['Revenu mensuel HTVA (€)', 'Monthly revenue excl. VAT (€)'],
